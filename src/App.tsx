...
import Result, { type GPAResults } from "./pages/Result";
import { Mail, Github, Linkedin, BookMarked } from "lucide-react";
import { Separator } from "@/components/ui/separator";
import { ThemeProvider } from "@/components/theme_toggle/theme-provider";
import { ModeToggle } from "./components/theme_toggle/mode-toggle";
  ...
  return (
    <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex">
          <Menubar
            className="w-fit m-2 mr-auto border transition-colors duration-300 hover:border-blue-500 dark:hover:border-yellow-500">
            <MenubarMenu>
          ...
          <Menubar className="w-fit m-2 ml-auto flex items-center gap-1">
            ...
            <Separator
              ...
              className="bg-blue-500 dark:bg-yellow-500 h-6"
            />
